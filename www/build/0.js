...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__list__ = __webpack_require__(333);
...
var ListPageModule = (function () {
    ...
    ListPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            ...
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["k" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__list__["a" /* ListPage */]),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_sweetalert2__ = __webpack_require__(328);
...
var ListPage = (function () {
    ...
    ListPage.prototype.fnRefresh = function () {
        this.modufiedData = [];
        this.modufiedData = this.myArrayData;
    };
    ListPage.prototype.fnSum = function () {
        var sum = this.modufiedData.reduce(function (previous, current) {
            var prevResult = Number.isInteger(previous) ? previous : previous.salary;
            return prevResult + current.salary;
        });
        __WEBPACK_IMPORTED_MODULE_3_sweetalert2___default()('' + JSON.stringify(sum), 'is your Total', 'success');
        console.log("SUM : " + JSON.stringify(sum));
    };
    ListPage.prototype.fnMax = function () {
        var most = this.modufiedData.reduce(function (previous, current) {
            var prevResult = Number.isInteger(previous) ? previous : previous.salary;
            var max = Math.max(prevResult, current.salary);
            return max;
        });
        __WEBPACK_IMPORTED_MODULE_3_sweetalert2___default()('' + JSON.stringify(most), 'is your max value', 'success');
        console.log("MAX : " + JSON.stringify(most));
    };
    ListPage.prototype.fnFind = function () {
        __WEBPACK_IMPORTED_MODULE_3_sweetalert2___default()('Up to 20K', 'display > 20K', 'success');
        this.modufiedData = this.modufiedData.filter(function (data) {
            return data.salary > 20;
        });
    };
    ListPage.prototype.fnLowHigh = function () {
    ...
    ListPage.prototype.fnHighLow = function () {
        this.modufiedData.sort(function (a, b) {
            if (a.salary > b.salary) {
                return -1;
            }
    ...
    ListPage.prototype.fnAtoZ = function () {
        this.modufiedData.sort(function (a, b) {
            if (a.name < b.name) {
                return -1;
            }
    ...
    ListPage.prototype.fnZtoA = function () {
        this.modufiedData.sort(function (a, b) {
            if (a.name > b.name) {
                return -1;
            }
    ...
    ListPage.prototype.filterItems = function (searchTerm) {
        return this.myArrayData.filter(function (item) {
    ...
    ListPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-list',template:/*ion-inline-start:"/Volumes/TimeMachine/AtoZ_Projects/IONIC_DEBUG/ion-panview/src/pages/list/list.html"*/'<ion-header>\n\n    <expandable-header [scrollArea]="mycontent" headerHeight="57">\n      <ion-toolbar>\n        <button ion-button menuToggle>\n        <ion-icon name="menu"></ion-icon>\n      </button>\n      <ion-searchbar round [(ngModel)]="SearchTerm" (ionCancel)="onCancel($event)" (ionInput)="setFilteredItems()"  [showCancelButton]="true">\n      </ion-searchbar> \n      <ion-buttons end>\n        <button ion-button menuToggle="right" >\n          <ion-icon name="ios-mail"></ion-icon>\n        </button>\n      </ion-buttons>\n    </ion-toolbar>\n    </expandable-header>\n\n  <ion-toolbar text-right >\n  	<ion-buttons>\n  	<button ion-button clear icon-end (click)="fnRefresh()">refresh <ion-icon name="refresh"></ion-icon></button>\n  	<button ion-button clear icon-end (click)="fnSum()">sum <ion-icon name="ios-add-circle-outline"></ion-icon></button>\n  	<button ion-button clear icon-end (click)="fnMax()">max <ion-icon name="checkmark-circle-outline"></ion-icon></button>\n  	<button ion-button clear icon-end (click)="fnFind()">find <ion-icon name="search"></ion-icon></button>\n  	<button ion-button clear icon-end (click)="fnLowHigh()">low-high <ion-icon name="ios-cash-outline"></ion-icon></button>\n  	<button ion-button clear icon-end (click)="fnHighLow()">high-low <ion-icon name="ios-cash-outline"></ion-icon></button>\n  	<button ion-button clear icon-end (click)="fnAtoZ()">A-Z <ion-icon name="trending-up"></ion-icon></button>\n  	<button ion-button clear icon-end (click)="fnZtoA()">Z-A <ion-icon name="trending-down"></ion-icon></button>\n  </ion-buttons>\n  </ion-toolbar>\n</ion-header>\n\n\n<ion-content fullscreen #mycontent>\n  <div *ngIf="searching" margin-top text-center>\n        <ion-spinner></ion-spinner>\n      </div>\n	<ion-row>\n		<ion-col col-xs-1 col-sm-6 col-md-6 col-lg-4 col-xl-3 *ngFor="let item of modufiedData">\n			<ion-item>\n				<h2 >{{item.name}}</h2>\n				<p>{{item.email}} </p>\n				<ion-note item-end>Salary : {{item.salary}}K</ion-note>\n			</ion-item>\n		</ion-col>\n\n	</ion-row>\n</ion-content>\n'/*ion-inline-end:"/Volumes/TimeMachine/AtoZ_Projects/IONIC_DEBUG/ion-panview/src/pages/list/list.html"*/,
        }),
